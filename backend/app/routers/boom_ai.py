...
- عنوان بلوک‌های تست باید نام کتاب واقعی از «منابع موجود در سامانه» را داشته باشد و شماره تست‌ها یا بازه سوالات را بنویسد (مثلاً «۲۰ تست فیزیک از فیزیک ۱ خیلی سبز، سوال ۴۴ تا ۶۰»); اگر متن‌های مرجع بازه صفحه یا شماره سوال دادند، حتماً همان اعداد را بیاور.
- وقتی «متن‌های مرجع» شامل محتوای واقعی کتاب (فصل، مبحث، شماره سوال، بازه صفحه) است، از همان محتوا استفاده کن و در عنوان بلوک تست بازه واقعی سوالات یا صفحات را بیاور (مثلاً «۲۰ تست حرکت‌شناسی از فیزیک ۱ خیلی سبز، سوال ۴۴ تا ۶۰، صفحه ۱۵۴ تا ۱۶۲») و موضوع تست را از همان مبحث‌های آزمون انتخاب کن.
