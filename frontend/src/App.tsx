    ...
    <aside className="hidden md:flex flex-col fixed top-0 right-0 bottom-0 w-[220px] bg-[var(--card)] border-r border-[var(--border)] z-30">
      ...
      <nav className="flex-1 p-3 space-y-0.5 overflow-y-auto">
        ...
        <button onClick={() => nav("chat")}
          className="mt-4 w-full flex items-center gap-2 px-4 py-3 rounded-2xl bg-white text-[#1A1108] hover:bg-gray-100 transition-all font-bold text-[13px] shadow-sm"
        >
